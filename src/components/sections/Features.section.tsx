...
const Features = () => {
  ...
  return (
    <section className='mb-16.5 md:mb-18.75 lg:mb-12.5'>
          <div className='px-3.75 md:px-12.5 flex flex-col gap-2 lg:max-w-95 lg:mx-auto'>
            <h1 className='text-preset-1 md:text-preset-2 text-blue-950 text-center'>Features</h1>
